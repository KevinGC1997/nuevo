...
import MisionTicGrupo18.Seguridad.Repositorios.RepositorioUsuario;
...
public class ControladorUsuario {
    ...
    @PostMapping
    public Usuario create(@RequestBody Usuario inforUsuario){
        inforUsuario.setContrasena(convertirSHA256(inforUsuario.getContrasena()));
        return this.miRepositorioUsuario.save(inforUsuario);
    }
